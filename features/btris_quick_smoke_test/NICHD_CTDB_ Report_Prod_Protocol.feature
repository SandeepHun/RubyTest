...
@NICHD_CTDB_Report_Test_Smoke_Test
Feature: BTRIS NICHD - CTDB Report Feature Prod Data

  @NICHD_CTDB_Report_Smoke_Test1
  ...
  #Login to the system.
    ...
    And the user remembers the value of "btris: nichd ctdb forms page" field into "Page Attribute" on "Btris/Portal" page
