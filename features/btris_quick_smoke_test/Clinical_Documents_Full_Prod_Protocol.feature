...
@Clinical_Documents_Full_Smoke_Test
Feature: BTRIS Clinical Documents - Full Text Feature Prod Data

  @ClinicalDocumentsFull_Smoke_Test1.1
  ...
  #Login to the system.
    ...
    And the user remembers the value of "btris: clinical documents full tex report page" field into "Page Attribute" on "Btris/Portal" page
