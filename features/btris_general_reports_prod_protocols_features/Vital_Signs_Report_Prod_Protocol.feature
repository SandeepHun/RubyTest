...
Feature: Vital Signs Report Prod Data
  ...
  Scenario Outline: 1.1 Vital Signs Report with Demographic with non-test protocols.
  #Login to the system.
    ...
    And the user verify the vital signs prod report on the table
  ...
  @VitalSign_Prod_Data2

  Scenario Outline: 6.2 Vital Signs Report with Demographic with non-test protocols.
  #Login to the system.
    Given the user navigates to / on browser
    And the user must see "Log in to BTRIS" text in "btris home: landing page" field on "Btris/Portal" page
    #Login to the BTRIS system.
