...
Feature: PDF Documents Report Feature Prod Data
  ...
  Scenario Outline: 5.1 NICHD/CTDB Report Test without PDF/Scanned Documents with non-test protocols.
  #Login to the system.
  ...
  Scenario Outline: 5.2 NICHD/CTDB Report Test with All PDF/Scanned Documents with non-test protocols.
  #Login to the system.
    Given the user navigates to / on browser
    And the user must see "Log in to BTRIS" text in "btris home: landing page" field on "Btris/Portal" page
    #Login to the BTRIS system.
