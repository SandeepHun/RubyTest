def map_btris_portal
  @page_objects['btris_portal'] =
...

      {
          ...
          'custom list search term box'                                                       =>"xpath^^.//*[@id='subject-lists-search-field']",
          ...
          'custom search term list: user field'                                               =>"xpath^^.//*[@id='subject-list-upload-user-field']",
          'custom search term list: list name field'                                          =>"xpath^^.//*[@id='subject-list-upload-name-field']",
          'custom search term list: description'                                              =>"xpath^^.//*[@id='subject-list-upload-description-field']",
          'custom search term list: domain drop down'                                         =>"xpath^^.//*[@id='red-list-upload-domain-field']",
          'custom search term list: brows upload'                                             =>"xpath^^.//*[@id='subject-list-upload-file-field']",
          'custom search term list: upload button'                                            =>"xpath^^.//*[@class='btn round btn-lg btn-primary']",
          'custom search term list: user'                                                     =>"xpath^^.//*[@id='subject-list-upload-user-field-listbox-BTRIS_TEST2']",
          'custom search term overwrite checkbox'                                             =>"xpath^^.//*[@class='custom-control custom-checkbox'][@for='subject-list-upload-overwrite-checkbox']",
